...
class ConvLSTM(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            hidden_state = self._init_hidden(batch_size=input_tensor.size(0), device=device)
...
class CLSTM(nn.Module):
    def __init__(self, input_size=(64, 64), channels=1, pred_len = 10, hidden_dim = [64], num_layers=1):
        ...
        self.out_channels = channels * pred_len
        self.pred_len = pred_len
        self.channels = channels
        
        self.output_layer = nn.Conv2d(in_channels = hidden_dim[-1], out_channels = self.out_channels,
    ...
    def forward(self, xx):
        ...
        b, _, h, w = out.shape
        out = out.reshape(b, self.pred_len, self.channels, h, w)
